<?php
/**
 * Class Google\WP_Fetch_Metadata\Tests\PHPUnit\Unit\Policy\Default_Isolation_Policies_Tests
 *
 ...
 */
class Default_Isolation_Policies_Tests extends Unit_Test_Case {
