...
* [open an issue](https://github.com/enricocarraro/wp-fetch-metadata/issues/new)
...
* push the changes to your fork and [submit a pull request](https://github.com/enricocarraro/wp-fetch-metadata/compare) to the `master` branch
