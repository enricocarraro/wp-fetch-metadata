...
* [open an issue](https://github.com/GoogleChromeLabs/wp-fetch-metadata/issues/new)
...
* make changes to the forked repository
    * write code that is backward-compatible with WordPress 5.0 and PHP 5.6
...
* push the changes to your fork and [submit a pull request](https://github.com/GoogleChromeLabs/wp-fetch-metadata/compare) to the `master` branch
...
* visit our project on [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/fetch-metadata) and sign in with your wordpress.org account (create one if you haven't yet)
